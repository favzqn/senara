...
export const allStoriesData: Story[] = [
  ...
  },
  {
    ...
    learningOutcomes: [
      ...
      "Understand basic investment types (stocks, mutual funds, deposits, gold)",
      "Apply risk vs return thinking to financial decisions",
      "Recognize investment scams and too-good-to-be-true promises"
    ],
    author: "Senara Team",
    scriptBy: "Senara Team",
  ...
  },
  {
    ...
    learningOutcomes: [
      ...
      "Distinguish empathy from sympathy in real situations",
      "Read non-verbal communication cues",
  ...
  },
  {
    ...
    learningOutcomes: [
      ...
      "Reduce food waste through planning and creativity"
    ],
    author: "Senara Team",
    scriptBy: "Senara Team",
    createdAt: "2026-06-13",
