...
const allStoriesData = [
  ...
  //   longDescription: "Pelajari dasar-dasar pemrograman melalui dialog interaktif. Anda akan memahami if-else statement, nested if, looping, variabel, logika ganda (AND/OR), dan teknik debugging. Setiap konsep dijelaskan dengan contoh kehidupan sehari-hari dan diikuti dengan 7 quiz interaktif untuk memperkuat pemahaman Anda. Ikuti perjalanan Naira di laboratorium komputer bersama Pak Dedi!",
  //   category: "college-work-adulthood",
