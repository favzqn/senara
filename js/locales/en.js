...
const LOCALES = { en: {
    ...
    terms: {
      ...
      sections: {
        ...
        disclaimer: {
          ...
          mentalBody: "Stories covering mental health are educational. If you're facing challenges, please contact qualified professionals. See the <a href='safety.html' style='color: #d97706;'>Safety</a> page for support lines.",
    ...
    safety: {
      ...
      supportBody2: "If you find any Senara content that feels unsafe or needs improvement, <a href='contact.html' style='color: #047857; text-decoration: underline;'>let us know</a>. Your feedback really matters to us."
    },
    privacy: {
    ...
    home: {
      // Hero
      badge: "Free · Nonprofit · No Sign-up",
      headline: "You don't just read these stories.<br><span class=\"text-[#4F46E5]\">You live them.</span>",
      subheadline: "Interactive stories about mental health, relationships, money, and life — told through characters who feel real. Every choice you make teaches something you won't forget.",
      ctaStart: "Start a Story",
      ctaLearnMore: "See How It Works",
      rating: "4.8 reader rating",
      readers: "1,250+ readers",
      free: "100% free",
      ...
      problemTitle: "The topics that matter most<br>are the hardest to learn.",
      problem1Title: "Mental health is misunderstood",
      problem1Desc: "1 in 5 young people struggle with mental health, but most don't know where to start learning about it.",
      problem2Title: "Textbooks don't connect",
      problem2Desc: "Important topics are wrapped in boring formats. You read, you forget. Nothing sticks.",
      problem3Title: "Free quality content is rare",
      problem3Desc: "Good educational content is locked behind paywalls. Free content is shallow or clickbait.",
      problemBridge: "What if learning about life felt like living through a story?",
      // Experience
      experienceLabel: "The Experience",
      experienceTitle: "Meet the characters.<br>Make the choices. Learn by living.",
      // What is Senara
      ...
      step1Label: "Step 1",
      step1Title: "Pick a story",
      step1Desc: "Browse topics — mental health, money, relationships, and more. Each story is a different world.",
      step2Label: "Step 2",
      step2Title: "Make choices",
      step2Desc: "You're not a spectator. You're in the story. Every decision leads somewhere different.",
      step3Label: "Step 3",
      step3Title: "Learn something real",
      step3Desc: "The lesson isn't a bullet point. It's a feeling. Something you experienced, not memorized.",
      // Featured
      ...
      // Categories
      topicsLabel: "Topics",
      categoriesTitle: "Stories about things that actually matter.",
      categoriesSubtitle: "Choose a category that matches your interests.",
      // Why
      whyLabel: "Why It Works",
      whyTitle: "Reading is passive.<br>Stories are experiences.",
      ...
      trad1: "Read a textbook, forget in a week",
      trad2: "One-way lectures, no participation",
      trad3: "Abstract concepts, no real context",
      trad4: "Often behind a paywall",
      senaraLabel: "Senara",
      sen1: "Experience the lesson through a character's eyes",
      sen2: "You make decisions — the story responds",
      sen3: "Topics grounded in real-life situations",
      sen4: "Free. No account needed. No catch.",
      ...
      // Climax
      climaxTitle: "Your first story is waiting.",
      climaxDesc: "No sign-up. No payment. Just pick a story and start.",
      climaxCta: "Browse Stories",
      // Support
      supportTitle: "Support Senara",
      supportSubtitle: "Senara is nonprofit and community-built. Every contribution keeps stories free for everyone.",
      ...
      demoTitle: "See what \"interactive story\" actually means.",
      demoStoryTag: "Mental Health Hero — Chapter 1",
      demoPlayFull: "Play Full Story",
      demoSpeaker: "Vani",
      demoText1: "Oh, hi! So you're the new Mental Health Hero candidate?",
      demoText2: "I'm Vani, an instructor at the Mental Health Hero Training Center.",
      demoText3: "I have a little quiz for you. Ready?",
      demoQuizQ: "Guess this: What percentage (%) of Indonesians aged 15\u201324 experience emotional mental disorders?",
      demoQuizA: "3%",
      demoQuizB: "5%",
      demoQuizC: "10%",
      demoCorrect: "Amazing, you got it right! 10%, or 1 in 10 young people, experience emotional mental disorders.",
      demoWrong: "Hmm, that's not quite right. The answer is actually 10% \u2014 pretty high, isn't it?",
      demoEndTitle: "Want to see what happens next?",
      demoEndDesc: "This was just the first 30 seconds. The full story has 5 chapters, 200+ scenes, and real branching paths.",
      demoEndCta: "Play Full Story"
    },
    footer: {
    ...
    categories: {
      ...
      "mind-emotions-desc": "Managing insecurity, anxiety, overthinking, and loneliness through relatable stories.",
      "self-awareness-identity-desc": "Understanding boundaries, self-worth, and authenticity in your personal journey.",
      "relationships-social-desc": "Navigating friendships, toxic people, dating, and conflict resolution.",
      "digital-life-online-desc": "Facing cyberbullying, filter anxiety, viral pressure, and online drama.",
      "college-work-adulthood-desc": "Dealing with first job, burnout, academic pressure, and life transitions.",
      "social-issues-desc": "Understanding privilege, bullying, inequality, and societal expectations.",
      "money-young-adult-life-desc": "Managing your first salary, impulsive buying, and the pressure to overwork for money."
    },
    // Story card labels
    story: {
      playNow: "Play Now →",
    ...
    tv: {
      ...
      ageKids: "Kids",
      ageTeen: "Teens",
      ageYoungAdult: "Young Adults",
      curatedVideo: "Curated educational video from Senara TV",
      preparing: "Videos are being prepared...",
      editorsPick: "✨ Editor's Pick",
      play: "Play",
      watchNow: "Watch Now",
      ...
      noMatch: "No matching videos. Try changing your filters or keywords.",
      watch: "Watch",
      today: "Today",
      yesterday: "Yesterday",
      daysAgo: "days ago",
      ...
      yearsAgo: "years ago",
      loadError: "Failed to load videos. Check your internet connection and reload the page.",
      reload: "Reload"
    },
    ...
    roadmap: {
      ...
      storiesNote: "💡 Have a story idea? <a href='contact.html' style='color: #d97706; text-decoration: underline;'>Contact us</a> or <a href='about.html?tab=contribute' style='color: #d97706; text-decoration: underline;'>join as a contributor</a>.",
      statuses: {
    ...
    team: {
      title: "Senara Team",
      subtitle: "The people behind the stories you read.",
      intro: "Senara is built by a small team that believes stories have the power to teach important topics in a way that touches the heart. We're not a big company, just a group of people who care.",
      whyTitle: "Why We Built Senara?",
      whyP1: "We saw many people around us struggling to understand important topics in life—mental health, digital literacy, finance, and soft skills—but not knowing where to start. The available information often felt preachy, boring, or irrelevant.",
      whyP2: "We believe there's a better way: <strong>through stories</strong>. Stories that make us feel \"that's so me\", that make us think without feeling lectured, and that anyone can access for free.",
      whyP3: "Senara was born from a simple belief: <em>everyone deserves to learn about important things in life, in a humane and free way.</em>",
      coreTitle: "Core Team",
      roleCEO: "CEO & Co-Founder",
      bioCEO: "Experienced in financial regulation and multinational FMCG. Co-founder of Diceritain (30K+ users). Psychology and product management background.",
      roleCTO: "CTO & Co-Founder",
      bioCTO: "6+ years in tech companies across Australia, Singapore, US, and Japan. Building products used by hundreds of thousands of users.",
      roleCOO: "COO & Co-Founder",
      bioCOO: "Managing talent development for 50K+ employees at a state-owned holding company. Top graduate. L&D and corporate learning background.",
      viewLinkedIn: "View LinkedIn →",
      creativeTitle: "Designers & Story Writers",
      roleDesigner: "Designer & Story Writer",
      jobPrim: "Silang.id · Freelance Graphic Designer & Illustrator · BISINDO Interpreter",
      bioPrim: "Visual creator with 4+ years experience in branding, social media, and multimedia. Certified Indonesian Sign Language (BISINDO) interpreter. Active in the Deaf community through Fantasi Tuli and GKI Pondok Indah.",
      valuesTitle: "Values We Hold",
      val1Title: "Free for Everyone",
      val1Desc: "No paywall, no exclusive content",
      val2Title: "Privacy First",
      val2Desc: "No personal data collected",
      val3Title: "Empathy in Stories",
      val3Desc: "Sensitive topics handled with care",
      val4Title: "Nonprofit",
      val4Desc: "No investors, no profit pressure",
      advisorTitle: "Supporters & Advisors",
      advisorIntro: "We're grateful to the professionals who provide input and support:",
      adv1Title: "Subject Matter Experts",
      adv1Desc: "Reviewing content accuracy across various fields",
      adv2Title: "Teachers & Educators",
      adv2Desc: "Feedback from an educator's perspective",
      adv3Title: "Beta Readers",
      adv3Desc: "Testing stories before release",
      adv4Title: "Community Feedback",
      adv4Desc: "Input from readers and users",
      contribTitle: "Contributors",
      contribIntro: "Senara wouldn't exist without the help of contributors who dedicate their time and expertise:",
      contribBoxTitle: "Thank you to everyone who has contributed!",
      contribBoxDesc: "Writers, illustrators, editors, testers, and everyone who helped make these stories happen.",
      roles: {
        writer: "✍️ Writers",
        illustrator: "🎨 Illustrators",
        editor: "📝 Editors",
