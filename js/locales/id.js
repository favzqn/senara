// Indonesian translations — loaded by locales.js when lang=id
const LOCALES = { id: {
    meta: {
      lang: "id",
    ...
    terms: {
      ...
      sections: {
        ...
        disclaimer: {
          ...
          mentalBody: "Cerita bertopik kesehatan mental dimaksudkan untuk edukasi. Jika kamu mengalami masalah kesehatan mental, hubungi profesional yang berkualifikasi. Lihat halaman <a href='safety.html' style='color: #d97706;'>Keselamatan</a> untuk daftar layanan bantuan.",
    ...
    safety: {
      ...
      supportBody2: "Jika kamu merasa ada konten di Senara yang berpotensi berbahaya atau perlu diperbaiki, silakan <a href='contact.html' style='color: #047857; text-decoration: underline;'>hubungi kami</a>. Kami sangat menghargai masukanmu."
    },
    privacy: {
    ...
    home: {
      // Hero
      badge: "Gratis · Nonprofit · Tanpa Daftar",
      headline: "Kamu tidak hanya membaca cerita ini.<br><span class=\"text-[#4F46E5]\">Kamu menjalaninya.</span>",
      subheadline: "Cerita interaktif tentang kesehatan mental, hubungan, uang, dan kehidupan — diceritakan melalui karakter yang terasa nyata. Setiap pilihan yang kamu buat mengajarkan sesuatu yang tak akan kamu lupakan.",
      ctaStart: "Mulai Cerita",
      ctaLearnMore: "Lihat Cara Kerjanya",
      rating: "Rating 4.8 dari pembaca",
      readers: "1,250+ pembaca",
      free: "100% gratis",
      ...
      problemTitle: "Topik yang paling penting<br>paling sulit dipelajari.",
      problem1Title: "Kesehatan mental sering disalahpahami",
      problem1Desc: "1 dari 5 remaja berjuang dengan kesehatan mental, tapi kebanyakan tidak tahu harus mulai dari mana.",
      problem2Title: "Buku teks tidak menyentuh",
      problem2Desc: "Topik penting dikemas dalam format membosankan. Kamu baca, kamu lupa. Tidak ada yang menempel.",
      problem3Title: "Konten berkualitas & gratis jarang ada",
      problem3Desc: "Konten edukatif yang bagus terkunci di balik paywall. Konten gratis dangkal atau clickbait.",
      problemBridge: "Bagaimana kalau belajar tentang kehidupan terasa seperti hidup di dalam cerita?",
      // Experience
      experienceLabel: "Pengalaman",
      experienceTitle: "Kenali karakternya.<br>Buat pilihanmu. Belajar dengan mengalami.",
      // What is Senara
      ...
      // How it works
      howLabel: "Cara Kerja",
      howTitle: "Tiga langkah. Nol gesekan.",
      howSubtitle: "Tiga langkah mudah untuk mulai belajar lewat cerita.",
      step1Label: "Langkah 1",
      step1Title: "Pilih cerita",
      step1Desc: "Jelajahi topik — kesehatan mental, uang, hubungan, dan lainnya. Setiap cerita adalah dunia yang berbeda.",
      step2Label: "Langkah 2",
      step2Title: "Buat pilihan",
      step2Desc: "Kamu bukan penonton. Kamu di dalam cerita. Setiap keputusan mengarah ke tempat yang berbeda.",
      step3Label: "Langkah 3",
      step3Title: "Belajar sesuatu yang nyata",
      step3Desc: "Pelajarannya bukan poin-poin. Ini perasaan. Sesuatu yang kamu alami, bukan hafalkan.",
      // Featured
      ...
      // Categories
      topicsLabel: "Topik",
      categoriesTitle: "Cerita tentang hal-hal yang benar-benar penting.",
      categoriesSubtitle: "Pilih kategori yang sesuai dengan minatmu.",
      // Why
      whyLabel: "Kenapa Ini Efektif",
      whyTitle: "Membaca itu pasif.<br>Cerita itu pengalaman.",
      whySubtitle: "Format cerita interaktif yang membuat belajar lebih menyenangkan dan mudah diingat.",
      traditionalLabel: "Belajar Tradisional",
      trad1: "Baca buku teks, lupa dalam seminggu",
      trad2: "Ceramah satu arah, tanpa partisipasi",
      trad3: "Konsep abstrak, tanpa konteks nyata",
      trad4: "Sering terkunci di balik paywall",
      senaraLabel: "Senara",
      sen1: "Alami pelajaran melalui mata karakter",
      sen2: "Kamu membuat keputusan — cerita merespons",
      sen3: "Topik yang berakar pada situasi kehidupan nyata",
      sen4: "Gratis. Tanpa akun. Tanpa syarat.",
      ...
      // Climax
      climaxTitle: "Cerita pertamamu menunggu.",
      climaxDesc: "Tanpa daftar. Tanpa bayar. Pilih cerita dan mulai.",
      climaxCta: "Jelajahi Cerita",
      // Support
      supportTitle: "Dukung Senara",
      supportSubtitle: "Senara adalah nonprofit yang dibangun komunitas. Setiap kontribusi menjaga cerita tetap gratis untuk semua.",
      ...
      contributeCta: "Berkontribusi",
      // About section
      aboutTitle: "Pelajari Lebih Lanjut",
      aboutSubtitle: "Platform nonprofit yang dibangun oleh tim kecil dengan misi besar.",
      aboutLink: "Tentang Senara",
      teamLink: "Tim",
      approachLink: "Pendekatan",
      roadmapLink: "Peta Jalan",
      orgLink: "Untuk Organisasi",
      donationLink: "Transparansi Donasi",
      // Demo
      demoLabel: "Coba Sekarang",
      demoTitle: "Lihat apa yang dimaksud \"cerita interaktif\".",
      demoStoryTag: "Pahlawan Kesehatan Mental — Bab 1",
      demoPlayFull: "Mainkan Cerita",
      demoSpeaker: "Vani",
      demoText1: "Oh, halo. Jadi, kamu adalah Calon Pahlawan Kesehatan Mental yang baru?",
      demoText2: "Aku Vani, instruktur di Pusat Pelatihan Pahlawan Kesehatan Mental.",
      demoText3: "Aku ada sedikit tebak-tebakan. Siap?",
      demoQuizQ: "Coba tebak. Menurutmu, berapa persen (%) penduduk Indonesia usia 15\u201324 tahun yang mengalami gangguan mental emosional?",
      demoQuizA: "3%",
      demoQuizB: "5%",
      demoQuizC: "10%",
      demoCorrect: "Hebat, tebakanmu benar! 10% atau 1 dari 10 pemuda mengalami gangguan mental-emosional.",
      demoWrong: "Hmm, jawabanmu kurang tepat. Angkanya sebenarnya 10% \u2014 cukup tinggi, ya?",
      demoEndTitle: "Ingin tahu apa yang terjadi selanjutnya?",
      demoEndDesc: "Ini baru 30 detik pertama. Cerita lengkapnya punya 5 bab, 200+ adegan, dan jalur cerita bercabang.",
      demoEndCta: "Mainkan Cerita"
    },
    footer: {
    ...
    categories: {
      ...
      "mind-emotions-desc": "Mengelola insecure, anxiety, overthinking, dan loneliness melalui cerita relatable.",
      "self-awareness-identity-desc": "Memahami boundaries, self-worth, dan authenticity dalam perjalanan diri.",
      "relationships-social-desc": "Navigasi friendships, toxic people, dating, dan conflict resolution.",
      "digital-life-online-desc": "Hadapi cyberbullying, filter anxiety, viral pressure, dan online drama.",
      "college-work-adulthood-desc": "Menghadapi first job, burnout, academic pressure, dan transisi kehidupan.",
      "social-issues-desc": "Memahami privilege, bullying, inequality, dan societal expectations.",
      "money-young-adult-life-desc": "Kelola gaji pertama, impulsive buying, dan tekanan overwork-for-money."
    },
    // Story card labels
    story: {
      playNow: "Mainkan Sekarang →",
    ...
    tv: {
      ...
      ageKids: "Anak-anak",
      ageTeen: "Remaja",
      ageYoungAdult: "Dewasa Muda",
      curatedVideo: "Video edukatif pilihan dari Senara TV",
      preparing: "Video sedang disiapkan...",
      editorsPick: "✨ Pilihan Tim",
      play: "Putar",
      ...
      noMatch: "Tidak ada video yang cocok. Coba ubah filter atau kata kunci.",
      watch: "Tonton",
      today: "Hari ini",
      yesterday: "Kemarin",
      daysAgo: "hari lalu",
      ...
      yearsAgo: "tahun lalu",
      loadError: "Gagal memuat video. Periksa koneksi internet dan coba muat ulang halaman.",
      reload: "Muat Ulang"
    },
    ...
    roadmap: {
      ...
      storiesNote: "💡 Punya ide cerita? <a href='contact.html' style='color: #d97706; text-decoration: underline;'>Hubungi kami</a> atau <a href='about.html?tab=contribute' style='color: #d97706; text-decoration: underline;'>bergabung sebagai kontributor</a>.",
      statuses: {
    ...
    team: {
      ...
      whyP1: "Kami melihat banyak orang di sekitar kami yang kesulitan memahami topik-topik penting dalam hidup—kesehatan mental, literasi digital, keuangan, dan soft skills—tapi tidak tahu harus mulai dari mana. Informasi yang ada seringkali terasa menggurui, membosankan, atau tidak relevan.",
      ...
      bioPrim: "Kreator visual dengan 4+ tahun pengalaman di branding, social media, dan multimedia. Juru bahasa isyarat Indonesia (BISINDO) bersertifikat. Aktif di komunitas Tuli melalui Fantasi Tuli dan GKI Pondok Indah.",
